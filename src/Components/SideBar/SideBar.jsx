...
function SideBar() {
    return (
        <aside className="flex h-[93vh] min-w-[13em]  flex-col overflow-y-auto border-r-2 bg-white px-5 pt-3 pb-4">
            {/* <a href="#">
                <svg
                    width="40"
                    height="46"
            ...
            <div className="mt-0 flex flex-1 flex-col justify-between">
                <nav className="-mx-3 space-y-6 ">
                    <div className="space-y-3 ">
                        ...
                        <NavLink
                            className={({ isActive }) => `flex transform items-center ${isActive ? "text-red-500" : "text-gray-600"} rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-red-500 `}
                            to="/"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <NavLink
                            className={({ isActive }) => `${isActive ? "text-red-500" : "text-gray-600"} flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-red-500 `}
                            to="/Fee"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        <a href="#" className="flex items-center gap-x-2">
                            <img
                                ...
                                alt="avatar"
                            />
                            <span className="text-sm font-medium text-gray-700 hover:text-red-500">JoyBoy</span>
                        </a>
                        <a
                            href="#"
